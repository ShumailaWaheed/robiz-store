          ...
          <div className="container px-5 py-5 mb-5 mx-auto flex flex-col">
            <div className="lg:w-5/6 mx-auto">
              ...
              <div className="flex flex-col sm:flex-row mt-10">
                ...
                <Image src={"/pic/shafiq.png"} alt="shaf" width={100} height={100} className="rounded-full"/>
                  </div>
                  <div className="flex flex-col items-center text-center justify-center">
                    ...
                    I am Shafique u Rehman, a passionate Front-End Developer and AI enthusiast. With a keen eye for design and a love for technology, I specialize in creating visually stunning and user-friendly websites. 
                    </p>
                  </div>
                </div>
                ...
                <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                  ...
                  <Link href={"https://github.com/SHAFIQUEKHANZADA"} className="text-indigo-500 inline-flex items-center">
                    Learn More
                    <svg
                      fill="none"
                      stroke="currentColor"
