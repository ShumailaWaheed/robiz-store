    ...
    <div>
      <div className="navbar bg-myWhite">
        <div className="navbar-start">
          ...
          <Link href={"/"}>
           <Image src={require("../public/Beige Elegant Fashion Style Business Store Logo/tt.png")} className="hidden lg:block ml-1" alt="logo" width={100} height={100}/></Link>
        </div>
        <div className="navbar-center">
        <Image src={require("../public/Beige Elegant Fashion Style Business Store Logo/s.png")}
